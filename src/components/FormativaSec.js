            ...
            <div className="row formativa">
                  <div className="col-1 col-sm-2 secundaria shadow w-auto">
                    ...
                    <div className="col-1 col-sm-2 secundaria shadow w-auto">
                        <p>NATURALES</p>
                        <ul className="list-unstyled">
                            <li><a className="btn btn-primary shadow w-100" href="https://forms.gle/wyxcbNr1DPZWLUov9" target="_blank" title="EDUCACION FORMATIVA DE CIENCIAS NATURALES-CENTRO EDUCATIVO SANTO CURA DE ARS">6TO</a></li><p />
                            <li><a className="btn btn-primary shadow w-100" href="https://forms.gle/M5A5qZXdwPQbXSfu9" target="_blank" title="EDUCACION FORMATIVA DE CIENCIAS NATURALES-CENTRO EDUCATIVO SANTO CURA DE ARS">5TO</a></li><p />
                            <li><a className="btn btn-primary shadow w-100" href="https://forms.gle/ah2n7vBhp1schfXf8" target="_blank" title="EDUCACION FORMATIVA DE CIENCIAS NATURALES-CENTRO EDUCATIVO SANTO CURA DE ARS">4TO</a></li><p />
