            ...
            <div className="row sumativa">
                  <div className="col-1 col-sm-2 secundaria shadow w-auto">
                    ...
                    <div className="col-1 col-sm-2 secundaria shadow w-auto">
                        <p>MATEMATICA</p>
                        <ul className="list-unstyled">
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE MATEMATICA-CENTRO EDUCATIVO SANTO CURA DE ARS">6TO</a></li><p />
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE MATEMATICA-CENTRO EDUCATIVO SANTO CURA DE ARS">5TO</a></li><p />
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE MATEMATICA-CENTRO EDUCATIVO SANTO CURA DE ARS">4TO</a></li><p />
