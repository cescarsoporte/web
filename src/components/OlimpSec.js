            ...
            <div className="row sumativa">
                  <div className="col-1 col-sm-2 secundaria shadow w-auto">
                        ...
                        <ul className="list-unstyled">
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE LENGUA ESPAÑOLA CENTRO EDUCATIVO SANTO CURA DE ARS">6TO</a></li><p />
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE LENGUA ESPAÑOLA CENTRO EDUCATIVO SANTO CURA DE ARS">5TO</a></li><p />
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE LENGUA ESPAÑOLA CENTRO EDUCATIVO SANTO CURA DE ARS">4TO</a></li><p />
                    ...
                    <div className="col-1 col-sm-2 secundaria shadow w-auto">
                        <p>MATEMATICA</p>
                        <ul className="list-unstyled">
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE MATEMATICA-CENTRO EDUCATIVO SANTO CURA DE ARS">CATEG. D</a></li><p />
                            <li><a className="btn btn-primary shadow w-100" href="https://docs.google.com/forms/d/e/1FAIpQLScaMYA1uPf8y4UDCselJqHdZG9ekh8jZbJZzaO8a91fhCPKMg/viewform" target="_blank" title="OLIMPIADA INTERNA DE MATEMATICA-CENTRO EDUCATIVO SANTO CURA DE ARS">CATEG. C</a></li><p />
                            <li><a className="btn btn-primary shadow w-100" href="https://docs.google.com/forms/d/e/1FAIpQLSdZTMCHGDTec__6udt_BGVK284Jk128qtH1v4jjhYV38aD34w/viewform?pli=1" target="_blank" title="OLIMPIADA INTERNA DE MATEMATICA-CENTRO EDUCATIVO SANTO CURA DE ARS">CATEG. B</a></li><p />
                            <li><a className="btn btn-primary disabled shadow w-100" href="https://docs.google.com/forms/d/e/1FAIpQLSe9G5FCcQj-y2FtybU-dnch0tqf0rkDmogDnGmyqHYNgplcTw/viewform" target="_blank" title="OLIMPIADA INTERNA DE matematica, categoría A: (5to y 6to de primaria).">CATEG. A</a></li><p />
                        </ul>
                    </div>
                    <div className="col-1 col-sm-2 secundaria shadow w-auto">
                        <p>NATURALES</p>
					...
					<div className="col-1 col-sm-2 secundaria shadow w-auto">
                        ...
                        <ul className="list-unstyled">
                            ...
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE QUIMICA-CENTRO EDUCATIVO SANTO CURA DE ARS">5TO</a></li><p />
                            ...
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE quimica, categoría A: (5to y 6to de primaria).">CATEG. A</a></li><p />
                        </ul>
                    </div>
					<div className="col-1 col-sm-2 secundaria shadow w-auto">
                        <p>FISICA</p>
                        <ul className="list-unstyled">
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE FISICA-CENTRO EDUCATIVO SANTO CURA DE ARS">6TO</a></li><p />
                            ...
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE fisica, categoría A: (5to y 6to de primaria).">CATEG. A</a></li><p />
                        </ul>
                    </div>
                </div>
      );
