                  ...
                  <div className="col-1 col-sm-2 secundaria shadow w-auto">
                    ...
                    <div className="col-1 col-sm-2 secundaria shadow w-auto">
                        ...
                        <ul className="list-unstyled">
                            ...
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="EDUCACION FORMATIVA DE MATEMATICA-CENTRO EDUCATIVO SANTO CURA DE ARS">4TO</a></li><p />
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="EDUCACION FORMATIVA DE MATEMATICA-CENTRO EDUCATIVO SANTO CURA DE ARS">3RO</a></li><p />
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="EDUCACION FORMATIVA DE MATEMATICA-CENTRO EDUCATIVO SANTO CURA DE ARS">2DO</a></li><p />
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="EDUCACION FORMATIVA DE MATEMATICA-CENTRO EDUCATIVO SANTO CURA DE ARS">1RO</a></li><p />
