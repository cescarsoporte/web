...
const Sitios = () => {
  const propuestasCourseraLinks = [
    { href: "https://www.coursera.org/learn/fundamentos-de-la-ciberseguridad", title: "En este primer curso del Certificado de Ciberseguridad de Google conocerás el mundo de la ciberseguridad a través de un plan de estudios interactivo, desarrollado por Google. Identificarás los eventos significativos que llevaron al desarrollo del campo de la ciberseguridad, conocerás su importancia para las operaciones comerciales actuales y explorarás las responsabilidades y habilidades laborales de un/a analista de ciberseguridad de nivel inicial. Te guiarán especialistas de Google, que actualmente trabajan en ciberseguridad, con actividades prácticas y ejemplos que simulan tareas comunes y frecuentes de este campo. Todo esto te ayudará a desarrollar tus habilidades y prepararte para trabajar. Los/las estudiantes que completen este certificado estarán preparados/as para solicitar trabajo en el área de la ciberseguridad, en un nivel inicial. No se necesita experiencia previa.", text: "Fundamentos de la ciberseguridad" },
    { href: "https://www.coursera.org/learn/fundamentos-de-la-ciberseguridad", title: "La transformación digital es un tema de gran interés, pero ¿qué es exactamente y qué significa para las compañías? En este curso, desarrollado en la Darden School of Business en la Universidad de Virginia y dirigido por los mejores profesores de Darden y expertos en gestión global de Boston Consulting Group, hablamos de transformación digital de dos maneras. Primero discutimos el ritmo del cambio y el imperativo que crea para las empresas. Luego, brindamos el contexto para esta transformación y lo que se necesita para ganar en la era digital. A continuación, analizamos el marco patentado de BCG, que lo ayuda a identificar áreas clave para digitalizar, incluida la estrategia, los procesos centrales y la tecnología. Al final de este curso, podrá: -describir la economía subyacente de la innovación, la tecnología y las disrupciones del mercado -sopesar los pros y los contras de las tecnologías digitales actuales que impulsan el avance -utilizar el marco de transformación digital de BCG como una «guía práctica» para digitalizar su organización", text: "Transformacion Digital" },
    { href: "https://www.coursera.org/learn/gen-ai-apps-transform-your-work-es", title: "Transform Your Work With Gen AI Apps is the fourth course of the Gen AI Leader learning path. This course introduces Google's gen AI applications, such as Gemini for Workspace and NotebookLM. It guides you through concepts like grounding, retrieval augmented generation, constructing effective prompts and building automated workflows.", text: "Apps de IA generativa: transforma tu trabajo" },
    { href: "https://www.coursera.org/learn/cybersecurity-for-managers", title: "En el mundo empresarial, los managers suelen ser el principal objetivo de un ciberataque, ya que tienen acceso a información confidencial, a cuentas o a transacciones económicas. Además, sus relaciones con múltiples contactos de interés como clientes, proveedores o personas de la misma organización los convierten en objetivos especialmente atractivos para los ciberdelincuentes. Por ello, en este curso trataremos las temáticas más relevantes en el ámbito de la ciberseguridad que debes conocer. Desde los riesgos a los que estamos expuestos, pasando por la importancia de la defensa personal y hasta cómo las organizaciones deben gestionar las crisis de seguridad o el diseño de procesos seguros. Anímate a adentrarte en el mundo de la ciberseguridad de la mano de este curso diseñado especialmente para managers. ¡Adelante!", text: "cybersecurity-for-managers" },
    { href: "https://www.coursera.org/learn/cybersecurity-for-managers", title: "La relevancia de apoyar a empresas de menor tamaño con capacitación en transformación digital radica en lo crítica que resulta esta materia, en el contexto actual, para su desarrollo y competitividad. Este MOOC fue diseñado para empresarios, cubriendo los temas claves a considerar en el proceso de transformación digital. Se abordará la necesidad de tener una estrategia digital y cómo elaborarla, la digitalización de procesos y sus factores críticos para el éxito, el marketing en un entorno digital, la implementación de canales digitales y sus implicancias, cómo enfrentar esta transformación desde la perspectiva de las personas, la gestión de sus competencias y el cambio cultural requerido. La metodología de este MOOC contempla una combinación de video clases y test auto-evaluables de selección múltiple, los cuales entregan retroalimentación a los alumnos para que puedan conocer su estado de avance en cuanto al aprendizaje esperado.  Se dicta en modalidad online, en formato masivo, pudiendo llegar a distintos lugares del mundo a través de la plataforma de Coursera. ", text: "claves-para-el-exito-de-la-transformacion-digital-en-pymes" },
    { href: "https://www.coursera.org/learn/gen-ai-agents-transform-your-organization-es", title: "Agentes de IA generativa: transforma tu organización es el quinto y último curso de la ruta de aprendizaje de Líder de IA generativa. En este curso, se explora cómo las organizaciones pueden utilizar los agentes de IA generativa personalizados para abordar desafíos empresariales específicos. Puedes obtener experiencia práctica a través de la creación de un agente de IA básico mientras exploras los componentes de estos agentes, como los modelos, los bucles de razonamiento y las herramientas.", text: "Agentes de IA generativa: transforma tu organización" },
    ...
    { href: "https://www.coursera.org/learn/ai-for-everyone-es", title: "La IA no es solo para ingenieros. Si desea que su organización esté mejor preparada en el uso de la IA, este es el curso que todos deberían hacer, especialmente sus colegas no técnicos.", text: "IA Para Todos (Español)" }
  ];
  const smvLinks = [
