                  ...
                  <div className="col-1 col-sm-2 secundaria shadow w-auto">
                    ...
                    <div className="col-1 col-sm-2 secundaria shadow w-auto">
                        ...
                        <ul className="list-unstyled">
                            ...
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE MATEMATICA-CENTRO EDUCATIVO SANTO CURA DE ARS">CATEG. C</a></li><p />
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE MATEMATICA-CENTRO EDUCATIVO SANTO CURA DE ARS">CATEG. B</a></li><p />
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE matematica, categoría A: (5to y 6to de primaria).">CATEG. A</a></li><p />
                        </ul>
                    </div>
                    <div className="col-1 col-sm-2 secundaria shadow w-auto">
                        <p>NATURALES</p>
                    ...
                    <div className="col-1 col-sm-2 secundaria shadow w-auto">
                        <p>SOCIALES</p>
                        <ul className="list-unstyled">
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE CIENCIAS SOCIALES, categoría A: (5to y 6to de secundaria).">CATEG. D</a></li><p />
							...
							<li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE CIENCIAS SOCIALES, categoría A: (1ro y 2do de secundaria).">CATEG. B</a></li><p />
					...
					<div className="col-1 col-sm-2 secundaria shadow w-auto">
                        <p>ENGLISH</p>
                        <ul className="list-unstyled">
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE INGLES-CENTRO EDUCATIVO SANTO CURA DE ARS">6TO</a></li><p />
                            ...
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE INGLES-CENTRO EDUCATIVO SANTO CURA DE ARS">4TO</a></li><p />
                            ...
                            <li><a className="btn btn-primary disabled shadow w-100" href="#" target="_blank" title="OLIMPIADA INTERNA DE INGLES, categoría A: (5to y 6to de primaria).">CATEG. A</a></li><p />
                        </ul>
                    </div>
                </div>
      );
